    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatsCard 
          ...
          colorClass="p-3 rounded-full bg-blue-100 text-blue-500 mr-4" 
          iconPath="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" 
        />
        <StatsCard 
          title="Active Users" 
          value={stats.activeUsers} 
          colorClass="p-3 rounded-full bg-green-100 text-green-500 mr-4"
          iconPath="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"
        />
        <StatsCard 
          title="Revenue" 
          value={stats.totalRevenue.toLocaleString()} 
          colorClass="p-3 rounded-full bg-yellow-100 text-yellow-500 mr-4"
          iconPath="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
        />
        <StatsCard 
          title="Pending Orders" 
          value={stats.pendingOrders} 
          colorClass="p-3 rounded-full bg-purple-100 text-purple-500 mr-4"
